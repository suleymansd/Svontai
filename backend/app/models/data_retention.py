...
class DataRetentionPolicy(Base):
    ...
    media_days: Mapped[int] = mapped_column(Integer, nullable=False, default=365)
    call_data_days: Mapped[int] = mapped_column(Integer, nullable=False, default=365)
    ticket_days: Mapped[int] = mapped_column(Integer, nullable=False, default=730)
    artifact_days: Mapped[int] = mapped_column(Integer, nullable=False, default=180)
