...
public_chat_init_rate_limiter = RateLimiter(10, 60, "public-chat-init")
public_chat_send_rate_limiter = RateLimiter(20, 60, "public-chat-send")
public_chat_bot_rate_limiter = RateLimiter(60, 60, "public-chat-bot")
public_chat_tenant_rate_limiter = RateLimiter(120, 60, "public-chat-tenant")
