...
(function() {
  ...
  let state = {
    ...
    isLoading: false,
    conversationId: null,
    externalUserId: localStorage.getItem('smartwa_user_id'),
    botInfo: null,
    messages: []
  };
  ...
  function createWidget(botInfo) {
    ...
    shadow.innerHTML = `
      ...
      <div class="smartwa-container ${position}">
        <div class="smartwa-window" id="smartwa-window">
          <div class="smartwa-header" style="background: ${primaryColor}">
            ...
            <button class="smartwa-close" id="smartwa-close">${icons.close}</button>
          </div>
          <div class="smartwa-messages" id="smartwa-messages"></div>
          <div class="smartwa-input-area">
            <input type="text" class="smartwa-input" id="smartwa-input" placeholder="Mesajınızı yazın...">
            <button class="smartwa-send" id="smartwa-send" style="background: ${primaryColor}">${icons.send}</button>
          </div>
        </div>
        <button class="smartwa-button" id="smartwa-button" style="background: ${primaryColor}">${icons.chat}</button>
      </div>
    `;
  ...
  function bindEvents(primaryColor) {
    ...
    const window = shadow.getElementById('smartwa-window');
  ...
  async function initializeChat(primaryColor) {
    try {
      ...
      localStorage.setItem('smartwa_user_id', data.external_user_id);
  ...
  function addMessage(text, sender, primaryColor) {
    ...
    messageEl.className = `smartwa-message ${sender}`;
  ...
  function hideTyping() {
    const typingEl = shadow.getElementById('smartwa-typing');
