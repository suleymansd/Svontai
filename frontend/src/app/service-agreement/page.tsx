  ...
  return (
    <LegalDocument
      ...
      sections={[
        ...
        { title: 'Veri koruma ve gizlilik', content: <p>Taraflar eriştikleri ticari sırları ve kişisel verileri yalnızca hizmet amacıyla, en az yetkiyle kullanır. Müşteri, kendi müşterilerinin verilerinde veri sorumlusudur; SvontAI sözleşme talimatlarıyla sınırlı veri işleyen olarak hareket eder. Ayrıntılı roller, güvenlik, alt işleyen, ihlal, yurt dışı aktarım ve imha hükümleri <Link href="/data-processing-agreement" className="text-primary underline">Kişisel Veri İşleme Ek Protokolü</Link> ile düzenlenir.</p> },
